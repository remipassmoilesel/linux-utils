...
table.insert(allGraphs, conky_get_mem_graph(offset + 186))
table.insert(allGraphs, conky_get_temperature_graph(offset + 384))
table.insert(allGraphs, conky_get_dir_graph('/', offset + 420))
table.insert(allGraphs, conky_get_dir_graph('/home', offset + 478))
