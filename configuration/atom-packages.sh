...
# jeudi 21 avril 2016, 22:21:11 (UTC+0200)
...
apm install auto-detect-indentation color-picker file-icons javascript-snippets emmet
apm install refactor js-refactor navigate docblockr hyperclicks js-hyperclick
