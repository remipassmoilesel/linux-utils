...
## Pousser une image vers un repository
    ...
    $ docker build -t bee-sample . 
    
    # associer une image avec un repo
    $ docker tag bee-sample beelab-repositories.bbuzcloud.com:5000/bee-sample:1.0.0
      
    $ docker push beelab-repositories.bbuzcloud.com:5000/bee-sample:1.0.0 
